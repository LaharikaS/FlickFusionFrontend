    ...
    const fetchData = async () => {
      try {
        ...
        const [recommendedRes] = await Promise.all([
          fetch('https://flickfusion-backend-zn4d.onrender.com/api/event/recommended')
        ]);
        ...
        const [featuredRes] = await Promise.all([
          fetch('https://flickfusion-backend-zn4d.onrender.com/api/event/featured')
        ]);
    ...
    <div className="content-section">
      <div className="promo-banner">
        <div className="promo-content">
          <h3>The best of Events</h3>
          <p>Discover the spots for the weekend!</p>
          <Link to="/Events" className="promo-button">Book Now!!</Link>
        </div>
